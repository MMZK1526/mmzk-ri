...
type ArrayFixed len e = ArrayFixed' len Int e
...
eraseLen :: ArrayFixed len e -> Array Int e
eraseLen = eraseLen'
{-# INLINE eraseLen #-}

eraseLen' :: ArrayFixed' len ix e -> Array ix e
...
injectLenUnsafe :: forall len e. Array Int e -> ArrayFixed len e
injectLenUnsafe = injectLenUnsafe'
{-# INLINE injectLenUnsafe #-}

injectLenUnsafe' :: forall len e ix. Array ix e -> ArrayFixed' len ix e
